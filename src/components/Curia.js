                ...
                <div className="row">
                  ...
                  >
                    <div className="content mr-auto ml-auto">
                          ...
                          >
                            ...
                            <Form.Group className="mb-3">
                              ...
                              <Form.Control
                                type="text"
                                placeholder="nature"
                                value={this.state.caseDetails.nature}
                                onChange={this.handleCaseInputChange}
                                name="nature"
                              />
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3">
                              ...
                              <Form.Control
                                type="text"
                                placeholder="def"
                                value={this.state.caseDetails.def}
                                onChange={this.handleCaseInputChange}
                                name="def"
                              />
                            </Form.Group>
                      ...
                      <br />
                      <Card>
                        <Card.Header as="h2">Upload Vakalat</Card.Header>
                        <Card.Body>
                          <Card.Title>
                            Provide the below details to submit Vakalat
                          </Card.Title>
                          ...
                          >
                            ...
                            <Form.Group className="mb-3">
                              <Form.Label>Upload Vakalat</Form.Label>
                              <Form.Control
                                type="file"
                                id="fname"
                      ...
                      <Card>
                        <Card.Header as="h2">Upload Replication</Card.Header>
                        <Card.Body>
                          <Card.Title>
                            Provide details to submit replication
                          </Card.Title>
                              ...
                              >
                                <li className="list-group-item">
                                  <p className="text-center">
                                    <img
                                      src={`https://ipfs.infura.io/ipfs/${evidence[1]}`}
                                      style={{ maxWidth: "420px" }}
                                    />
                                  </p>
                                  <p>Description: {evidence[0]}</p>
                                  <p>Date: {evidence[2]}</p>
                                </li>
                              </ul>
                            </div>
